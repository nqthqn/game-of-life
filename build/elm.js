...
var _fizwidget$game_of_life$History$didChange = function (_p0) {
	var _p1 = _p0;
	return A2(
		...
		A2(
			...
			_elm_lang$core$List$head(_p1._2)));
};
var _fizwidget$game_of_life$History$now = function (_p2) {
	var _p3 = _p2;
	return _p3._1;
};
var _fizwidget$game_of_life$History$History = F3(
	function (a, b, c) {
		return {ctor: 'History', _0: a, _1: b, _2: c};
	});
var _fizwidget$game_of_life$History$begin = function (present) {
	return A3(
		_fizwidget$game_of_life$History$History,
		{ctor: '[]'},
		present,
		{ctor: '[]'});
};
var _fizwidget$game_of_life$History$record = F2(
	function (step, _p4) {
		var _p5 = _p4;
		var _p6 = _p5._1;
		return A3(
			...
			{ctor: '[]'},
			step(_p6),
			{ctor: '::', _0: _p6, _1: _p5._2});
	});
var _fizwidget$game_of_life$History$undo = function (_p7) {
	var _p8 = _p7;
	var _p12 = _p8._1;
	var _p11 = _p8._2;
	var _p10 = _p8._0;
	...
	if (_p9.ctor === '::') {
		return A3(
			_fizwidget$game_of_life$History$History,
			{ctor: '::', _0: _p12, _1: _p10},
			_p9._0,
			_p9._1);
	} else {
		return A3(_fizwidget$game_of_life$History$History, _p10, _p12, _p11);
	}
};
var _fizwidget$game_of_life$History$redo = function (_p13) {
	var _p14 = _p13;
	var _p15 = _p14._0;
	if (_p15.ctor === '::') {
		return _elm_lang$core$Maybe$Just(
...
var _fizwidget$game_of_life$Matrix$toList = function (_p4) {
	var _p5 = _p4;
	return _elm_lang$core$Array$toList(_p5._1);
};
var _fizwidget$game_of_life$Matrix$all = F2(
	function (predicate, _p6) {
		var _p7 = _p6;
		return _elm_lang$core$Array$isEmpty(
			A2(
				_elm_lang$core$Array$filter,
				function (_p8) {
					return !predicate(_p8);
				},
				_p7._1));
	});
...
var _fizwidget$game_of_life$Matrix$toCoordinate = F2(
	function (_p11, index) {
		...
		return (_elm_lang$core$Native_Utils.cmp(index, _p14 * _p13) < 0) ? {
			x: A2(_elm_lang$core$Basics_ops['%'], index, _p14),
			y: (index / _p14) | 0
		} : {x: _p14 - 1, y: _p13 - 1};
	});
var _fizwidget$game_of_life$Matrix$wrap = F3(
	function (min, max, value) {
		return (_elm_lang$core$Native_Utils.cmp(value, min) < 0) ? max : ((_elm_lang$core$Native_Utils.cmp(value, max) > 0) ? min : value);
	});
var _fizwidget$game_of_life$Matrix$toIndex = F2(
	function (_p16, _p15) {
		...
		var _p19 = _p17.width;
		var _p18 = _p15;
		var wrappedY = A3(_fizwidget$game_of_life$Matrix$wrap, 0, _p17.height - 1, _p18.y);
		var wrappedX = A3(_fizwidget$game_of_life$Matrix$wrap, 0, _p19 - 1, _p18.x);
		return (wrappedY * _p19) + wrappedX;
	});
var _fizwidget$game_of_life$Matrix$get = F2(
	function (coordinate, _p20) {
		var _p21 = _p20;
		return A2(
			_elm_lang$core$Array$get,
			A2(_fizwidget$game_of_life$Matrix$toIndex, _p21._0, coordinate),
			_p21._1);
	});
var _fizwidget$game_of_life$Matrix$neighbours = F2(
	function (matrix, coordinate) {
		return A2(
			...
			A2(_elm_lang$core$Basics$flip, _fizwidget$game_of_life$Matrix$get, matrix),
			A2(
				_elm_lang$core$List$map,
				_fizwidget$game_of_life$Matrix$offsetBy(coordinate),
				{
					ctor: '::',
...
var _fizwidget$game_of_life$Matrix$Coordinate = F2(
	function (a, b) {
		return {x: a, y: b};
	});
var _fizwidget$game_of_life$Matrix$Matrix = F2(
	function (a, b) {
	...
	function (coordinate, value, _p28) {
		...
		return A2(
			...
			A3(
				...
				A2(_fizwidget$game_of_life$Matrix$toIndex, _p30, coordinate),
				value,
				_p29._1));
	});
	...
	function (f, coordinate, matrix) {
		return A2(
			...
			A2(
				_elm_lang$core$Maybe$map,
				function (value) {
					return A3(_fizwidget$game_of_life$Matrix$set, coordinate, value, matrix);
				},
				A2(
					_elm_lang$core$Maybe$map,
					f,
					A2(_fizwidget$game_of_life$Matrix$get, coordinate, matrix))));
	});
...
var _fizwidget$game_of_life$Main$tickInterval = function (speed) {
	var _p0 = speed;
	if (_p0.ctor === 'Slow') {
		return 600 * _elm_lang$core$Time$millisecond;
	} else {
...
var _fizwidget$game_of_life$Main$blank = A2(
	...
	{ctor: '[]'},
	{ctor: '[]'});
var _fizwidget$game_of_life$Main$buttonStyles = {
	ctor: '::',
			...
			_rtfeldman$elm_css$Html_Styled$button,
			{
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
						A2(_elm_lang$core$Basics_ops['++'], _fizwidget$game_of_life$Main$buttonStyles, styles)),
					_1: {ctor: '[]'}
				}
			},
			{
...
var _fizwidget$game_of_life$Main$viewCellContent = F3(
				...
				_0: _rtfeldman$elm_css$Html_Styled_Attributes$css(
					{
						...
						_0: _rtfeldman$elm_css$Css$width(
							_rtfeldman$elm_css$Css$pct(
								_fizwidget$game_of_life$Main$cellContentSize(cell))),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Css$height(
								_rtfeldman$elm_css$Css$pct(
							...
							_1: {
								ctor: '::',
								_0: _rtfeldman$elm_css$Css$backgroundColor(
									A2(_fizwidget$game_of_life$Main$cellColor, cell, coordinate)),
								_1: {
									ctor: '::',
									_0: _rtfeldman$elm_css$Css$borderRadius(
									...
									_1: {
										...
										_0: _rtfeldman$elm_css$Css_Transitions$transition(
											{
												ctor: '::',
												_0: A3(_rtfeldman$elm_css$Css_Transitions$backgroundColor3, transitionDuration, 0, _rtfeldman$elm_css$Css_Transitions$easeInOut),
												_1: {
													ctor: '::',
													_0: _rtfeldman$elm_css$Css_Transitions$width(transitionDuration),
													_1: {
														ctor: '::',
														_0: _rtfeldman$elm_css$Css_Transitions$height(transitionDuration),
														_1: {ctor: '[]'}
													}
												}
											}),
...
var _fizwidget$game_of_life$Main$squareContainer = function (content) {
	return A2(
		_rtfeldman$elm_css$Html_Styled$div,
		{
			ctor: '::',
...
var _fizwidget$game_of_life$Main$rightKey = 39;
var _fizwidget$game_of_life$Main$leftKey = 37;
var _fizwidget$game_of_life$Main$Model = F4(
	function (a, b, c, d) {
		return {status: a, cells: b, mouse: c, speed: d};
	});
var _fizwidget$game_of_life$Main$Playing = {ctor: 'Playing'};
var _fizwidget$game_of_life$Main$Paused = {ctor: 'Paused'};
var _fizwidget$game_of_life$Main$pauseWhenSettled = function (_p6) {
	var _p7 = _p6;
	var _p9 = _p7;
	var _p8 = _p7.status;
	if (_p8.ctor === 'Playing') {
		return _fizwidget$game_of_life$History$didChange(_p7.cells) ? _p9 : _elm_lang$core$Native_Utils.update(
			_p9,
...
var _fizwidget$game_of_life$Main$toggleStatus = function (status) {
	var _p10 = status;
	if (_p10.ctor === 'Playing') {
		return _fizwidget$game_of_life$Main$Paused;
	} else {
		return _fizwidget$game_of_life$Main$Playing;
	}
};
var _fizwidget$game_of_life$Main$Down = {ctor: 'Down'};
var _fizwidget$game_of_life$Main$Up = {ctor: 'Up'};
var _fizwidget$game_of_life$Main$Fast = {ctor: 'Fast'};
var _fizwidget$game_of_life$Main$Slow = {ctor: 'Slow'};
var _fizwidget$game_of_life$Main$Dead = {ctor: 'Dead'};
var _fizwidget$game_of_life$Main$initialCells = A2(
...
var _fizwidget$game_of_life$Main$init = {
	...
	_0: {
		status: _fizwidget$game_of_life$Main$Paused,
		cells: _fizwidget$game_of_life$History$begin(_fizwidget$game_of_life$Main$initialCells),
		mouse: _fizwidget$game_of_life$Main$Up,
		speed: _fizwidget$game_of_life$Main$Slow
	},
	_1: _elm_lang$core$Platform_Cmd$none
};
var _fizwidget$game_of_life$Main$Alive = {ctor: 'Alive'};
var _fizwidget$game_of_life$Main$liveNeighbours = F2(
	function (cells, coordinate) {
		return _elm_lang$core$List$length(
			A2(
				...
				A2(_fizwidget$game_of_life$Matrix$neighbours, cells, coordinate)));
	});
...
var _fizwidget$game_of_life$Main$nextGeneration = function (cells) {
	return A2(
		_fizwidget$game_of_life$Matrix$coordinateMap,
		_fizwidget$game_of_life$Main$updateCell(cells),
		cells);
};
var _fizwidget$game_of_life$Main$onKeyDown = F2(
	function (keyCode, _p12) {
		var _p13 = _p12;
		var _p15 = _p13;
		var _p14 = _p13.cells;
		return _elm_lang$core$Native_Utils.eq(
			...
			_elm_lang$core$Char$toCode(
				_elm_lang$core$Native_Utils.chr('P'))) ? _elm_lang$core$Native_Utils.update(
			_p15,
			{
				status: _fizwidget$game_of_life$Main$toggleStatus(_p13.status)
			}) : (_elm_lang$core$Native_Utils.eq(keyCode, _fizwidget$game_of_life$Main$rightKey) ? _elm_lang$core$Native_Utils.update(
			_p15,
			{
				status: _fizwidget$game_of_life$Main$Paused,
				cells: A2(
					_elm_lang$core$Maybe$withDefault,
					A2(_fizwidget$game_of_life$History$record, _fizwidget$game_of_life$Main$nextGeneration, _p14),
					_fizwidget$game_of_life$History$redo(_p14))
			}) : (_elm_lang$core$Native_Utils.eq(keyCode, _fizwidget$game_of_life$Main$leftKey) ? _elm_lang$core$Native_Utils.update(
			_p15,
			{
				status: _fizwidget$game_of_life$Main$Paused,
				cells: _fizwidget$game_of_life$History$undo(_p14)
			}) : _p15));
	});
var _fizwidget$game_of_life$Main$stepForward = function (cells) {
	return A2(
		_elm_lang$core$Maybe$withDefault,
		A2(_fizwidget$game_of_life$History$record, _fizwidget$game_of_life$Main$nextGeneration, cells),
		_fizwidget$game_of_life$History$redo(cells));
};
var _fizwidget$game_of_life$Main$toggleCell = F2(
	function (coordinate, cells) {
		...
		return A3(_fizwidget$game_of_life$Matrix$update, toggle, coordinate, cells);
	});
var _fizwidget$game_of_life$Main$update = F2(
	function (msg, _p17) {
		...
		switch (_p19.ctor) {
			...
			case 'Tick':
				return _fizwidget$game_of_life$Main$noCmd(
					_fizwidget$game_of_life$Main$pauseWhenSettled(
						_elm_lang$core$Native_Utils.update(
							_p22,
							{
								cells: A2(_fizwidget$game_of_life$History$record, _fizwidget$game_of_life$Main$nextGeneration, _p21)
							})));
			case 'SetSpeed':
				return _fizwidget$game_of_life$Main$noCmd(
					_elm_lang$core$Native_Utils.update(
					...
					_elm_lang$core$Native_Utils.update(
						_p22,
						{
							...
							cells: A2(
								...
								_fizwidget$game_of_life$Main$toggleCell(_p19._0),
								_p21)
						}));
			case 'MouseUp':
				return _fizwidget$game_of_life$Main$noCmd(
			...
			case 'MouseOver':
				var _p20 = _p18.mouse;
				if (_p20.ctor === 'Up') {
					return _fizwidget$game_of_life$Main$noCmd(_p22);
				} else {
					return _fizwidget$game_of_life$Main$noCmd(
						_elm_lang$core$Native_Utils.update(
							_p22,
			...
			default:
				return _fizwidget$game_of_life$Main$noCmd(
					A2(_fizwidget$game_of_life$Main$onKeyDown, _p19._0, _p22));
		}
	});
var _fizwidget$game_of_life$Main$KeyDown = function (a) {
	return {ctor: 'KeyDown', _0: a};
};
var _fizwidget$game_of_life$Main$MouseOver = function (a) {
	return {ctor: 'MouseOver', _0: a};
};
var _fizwidget$game_of_life$Main$MouseUp = {ctor: 'MouseUp'};
var _fizwidget$game_of_life$Main$MouseDown = function (a) {
	return {ctor: 'MouseDown', _0: a};
};
var _fizwidget$game_of_life$Main$viewCell = F4(
	function (transitionDuration, size, coordinate, cell) {
		return A2(
			_rtfeldman$elm_css$Html_Styled$div,
			{
				ctor: '::',
				...
				_1: {
					...
					_0: _rtfeldman$elm_css$Html_Styled_Events$onMouseDown(
						_fizwidget$game_of_life$Main$MouseDown(coordinate)),
					_1: {
						ctor: '::',
						_0: _rtfeldman$elm_css$Html_Styled_Events$onMouseUp(_fizwidget$game_of_life$Main$MouseUp),
						_1: {
							ctor: '::',
							_0: _rtfeldman$elm_css$Html_Styled_Events$onMouseEnter(
								_fizwidget$game_of_life$Main$MouseOver(coordinate)),
							_1: {ctor: '[]'}
						}
					}
				}
			...
			{
				ctor: '::',
				_0: A3(_fizwidget$game_of_life$Main$viewCellContent, transitionDuration, cell, coordinate),
				_1: {ctor: '[]'}
			});
	});
var _fizwidget$game_of_life$Main$viewCells = F2(
	function (transitionDuration, cells) {
		return A2(
			...
			_fizwidget$game_of_life$Matrix$toList(
				A2(
					_fizwidget$game_of_life$Matrix$coordinateMap,
					A2(
...
var _fizwidget$game_of_life$Main$viewSpeedButton = F2(
	function (status, speed) {
		...
		if (_p23._0.ctor === 'Playing') {
			...
			return _fizwidget$game_of_life$Main$blank;
		}
	});
var _fizwidget$game_of_life$Main$Tick = {ctor: 'Tick'};
var _fizwidget$game_of_life$Main$subscriptions = function (_p24) {
	var _p25 = _p24;
	var keyDowns = _elm_lang$keyboard$Keyboard$downs(_fizwidget$game_of_life$Main$KeyDown);
	var ticks = function () {
		var _p26 = _p25.status;
		if (_p26.ctor === 'Playing') {
			return A2(
				_elm_lang$core$Time$every,
				_fizwidget$game_of_life$Main$tickInterval(_p25.speed),
...
var _fizwidget$game_of_life$Main$viewControls = F3(
	function (status, speed, cells) {
		return A2(
			...
			{
				ctor: '::',
				_0: A2(_fizwidget$game_of_life$Main$viewStatusButton, status, cells),
				_1: {
					ctor: '::',
...
var _fizwidget$game_of_life$Main$view = function (_p28) {
	...
	return A2(
		...
		{
			ctor: '::',
			_0: _fizwidget$game_of_life$Main$squareContainer(
...
var Elm = {};
Elm['Main'] = Elm['Main'] || {};
if (typeof _fizwidget$game_of_life$Main$main !== 'undefined') {
    _fizwidget$game_of_life$Main$main(Elm['Main'], 'Main', undefined);
}
